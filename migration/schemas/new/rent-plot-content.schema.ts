...
export const RentPlotContentSchema = new Schema<IPlotContent<ObjectId>, Model<IPlotContent<ObjectId>>>(
  {
  ...
  { collection: 'rentplotcontents' },
);

export const RentPlotContentModel = mongoose.model<IPlotContent<ObjectId>, Model<IPlotContent<ObjectId>>>('RentPlotContents', RentPlotContentSchema);
